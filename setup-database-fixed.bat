...
if !MYSQL_FOUND! EQU 0 if exist "C:\Program Files\MySQL\MySQL Server 8.4\bin\mysql.exe" (
...
if !MYSQL_FOUND! EQU 0 if exist "C:\Program Files (x86)\MySQL\MySQL Server 8.0\bin\mysql.exe" (
...
if !MYSQL_FOUND! EQU 0 if exist "C:\xampp\mysql\bin\mysql.exe" (
...
if !MYSQL_FOUND! EQU 0 (
    ...
    echo.
    echo Or manually add MySQL to your PATH environment variable.
    pause
    exit /b 1
)
...
if !ERRORLEVEL! EQU 0 (
    ...
    echo.
    echo 2. Verify credentials by connecting manually:
